...
public enum Token_Class
{
	...
	PlusOp, MinusOp, MultiplyOp, DivideOp, Idenifier, IntNumber, FloatNumber, Number, LPracket, RPracket, StringLine, Comment
}
namespace JASON_Compiler
{
	...
	public class Scanner
	{
		...
		//{
		//	var regexString = new Regex(@"/\*(\S|\s)*\*/", RegexOptions.Compiled);
		//	bool isValid = regexString.IsMatch(lex);
		//	return isValid;
